...
const ProductForm = ({ handleSubmit, product, setProduct, loading }) => {
    ...
    return (
        ...
        >
            ...
            {/* Submit Button */}
            <button type="submit" className="border-none outline-none p-3 text-[clamp(12px,1.8vw,14px)] bg-black text-white font-semibold rounded-sm tracking-wider active:scale-90 cursor-pointer duration-300 ease-in-out mt-1 items-center justify-center flex hover:bg-black/90"

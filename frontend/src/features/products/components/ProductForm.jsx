    ...
    return (
        ...
        >
            <div className="flex flex-col items-start justify-center mb-1">
                <h1 className="text-white/60 text-lg">Curate Your Product</h1>

                {/* Heading with Custom Pulse Dots */}
                <p className="text-[clamp(34px,4vw,22px)] font-semibold tracking-tight relative flex items-center pl-7.5 text-[#00bfff] mb-1">

        ...
        <div className="border border-black/20 rounded-sm overflow-hidden bg-white h-full flex flex-col shadow-sm ">
            <div className="p-4 flex flex-col gap-4 flex-1 justify-between">
                <div className="flex flex-col gap-4">
                    ...
                    <p className="tracking-wide text-lg"><span className="italic text-sm">Product - </span>{product?.title}</p>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span
                            className="w-7 text-center font-bold text-sm">{variant.stock}</span>
                    ...
                    <div>
                        ...
                        <ImageUploadZone imageInputRef={imageInputRef} handleImageFileUpload={handleImageFileUpload} />
                                        ...
                                        <div key={preview.id} className="relative rounded-lg border border-black/10 overflow-hidden bg-[#faf8f5] h-fit w-fit">
                                            <button
                                                ...
                                                onClick={() => {
                                                    setVariant({
                                                        ...variant,
                                                        images: variant.images.filter(img => img.id !== preview.id)
                                                    });
                                                }}
